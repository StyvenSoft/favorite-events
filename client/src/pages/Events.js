            ...
            <React.Fragment>
                ...
                {this.state.selectedEvent &&
                    ...
                    >
                        ...
                        <strong>Date: </strong><span>{new Date(this.state.selectedEvent.date).toLocaleDateString()}</span><br /><br />
                        <strong>Description: </strong><p>{this.state.selectedEvent.description}</p>
                    </Modal>
                }
                {this.context.token && (
